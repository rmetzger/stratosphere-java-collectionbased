...
public abstract class Serializer<T> {
	...
	/**
	 * Serializes the given value to the given target output view.
	 * 
	 * @param record The value to serialize.
	 ...
	 */
	public abstract void serialize(T value, DataOutputView target) throws IOException;

	/**
	 * De-serializes a value from the given source input view. May reuse the other given value
	 * as the target to place the deserialized data into.
	 * 
	 * @param reuse The value instance optionally usable to de-serialize the data into.
	 * @param source The input view from which to read the data.
	 * 
	 * @return The deserialized value. This object may be the same as the reusable object, if the latter was
	 *         used to place the deserialized data into.
	 * 

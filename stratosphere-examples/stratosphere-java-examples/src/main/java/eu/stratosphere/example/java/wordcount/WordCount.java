...
public class WordCount {
	...
	public static final class Tokenizer extends FlatMapFunction<Tuple1<String>, Tuple2<String, Integer>> {
		
		public void flatMap(Tuple1<String> value, Collector<Tuple2<String, Integer>> out) {
			String[] tokens = value._1.toLowerCase().split("\\W");
	...
	public static void main(String[] args) {
		...
		final ExecutionContext context = ExecutionContext.createLocalExecutionContext();
		
		DataSet<Tuple1<String>> text = context.readTextFile(new Path(inputPath));

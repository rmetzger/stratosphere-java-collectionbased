...
public final class Tuple7<T1, T2, T3, T4, T5, T6, T7> extends Tuple {
	...
	static {
		try {
			offsets[0] = UNSAFE.objectFieldOffset(Tuple7.class.getField("_1"));
			offsets[1] = UNSAFE.objectFieldOffset(Tuple7.class.getField("_2"));
			offsets[2] = UNSAFE.objectFieldOffset(Tuple7.class.getField("_3"));
			offsets[3] = UNSAFE.objectFieldOffset(Tuple7.class.getField("_4"));
			offsets[4] = UNSAFE.objectFieldOffset(Tuple7.class.getField("_5"));
			offsets[5] = UNSAFE.objectFieldOffset(Tuple7.class.getField("_6"));
			offsets[6] = UNSAFE.objectFieldOffset(Tuple7.class.getField("_7"));
		} catch (Throwable t) {
